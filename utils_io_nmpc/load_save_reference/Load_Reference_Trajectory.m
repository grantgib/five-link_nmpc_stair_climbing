...
if isequal(dir,"Ascend")
    full_ref = load(fullfile(pwd,'FROST_trajectory_generation/trajectory_coefficients/time_based_trivial_virts/ascend_gaits',traj_name));
else
    full_ref = load(fullfile(pwd,'FROST_trajectory_generation/trajectory_coefficients/descend_gaits/old_virts',traj_name));
end
