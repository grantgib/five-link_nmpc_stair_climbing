...
restoredefaultpath;
if isunix
    addpath('external_packages/casadi-linux-matlabR2014b-v3.5.5');
    import casadi.*
else
    addpath('external_packages/casadi-windows-matlabR2016a-v3.5.5');
    import casadi.*
end
addpath(genpath('utils_io_nmpc/'));
addpath(genpath('FROST_trajectory_generation'));
